...
BEGIN
    ...
    INSERT INTO remapping_log (step, message) VALUES ('Step 15', 'Reinsert from deleted completed successfully');
EXCEPTION
    WHEN OTHERS THEN
        INSERT INTO remapping_log (step, message) VALUES ('Step 15', 'Error in Step 15: ' || SQLERRM);
        RAISE;
END;
$$ LANGUAGE plpgsql;
...
BEGIN
    ...
    IF NOT table_exists THEN
        INSERT INTO remapping_log (step, message) VALUES ('Step 16', 'Table faers_b.drug_mapper_2 does not exist, skipping Step 16');
        RETURN;
    END IF;

    SELECT COUNT(*) INTO row_count FROM faers_b.drug_mapper_2;
    IF row_count = 0 THEN
        INSERT INTO remapping_log (step, message) VALUES ('Step 16', 'Table faers_b.drug_mapper_2 is empty, skipping Step 16');
        RETURN;
    END IF;
    ...
    INSERT INTO remapping_log (step, message) VALUES ('Step 16', 'Delete marked rows completed successfully');
EXCEPTION
    WHEN OTHERS THEN
        INSERT INTO remapping_log (step, message) VALUES ('Step 16', 'Error in Step 16: ' || SQLERRM);
        RAISE;
END;
$$ LANGUAGE plpgsql;
...
BEGIN
    ...
    IF NOT table_exists THEN
        INSERT INTO remapping_log (step, message) VALUES ('Step 17', 'Table faers_b.drug_mapper_2 does not exist, skipping Step 17');
        RETURN;
    END IF;

    SELECT COUNT(*) INTO row_count FROM faers_b.drug_mapper_2;
    IF row_count = 0 THEN
        INSERT INTO remapping_log (step, message) VALUES ('Step 17', 'Table faers_b.drug_mapper_2 is empty, skipping Step 17');
        RETURN;
    END IF;
    ...
    INSERT INTO remapping_log (step, message) VALUES ('Step 17', 'Clean duplicates completed successfully');
EXCEPTION
    WHEN OTHERS THEN
        INSERT INTO remapping_log (step, message) VALUES ('Step 17', 'Error in Step 17: ' || SQLERRM);
        RAISE;
END;
$$ LANGUAGE plpgsql;
...
BEGIN
    ...
    IF NOT table_exists THEN
        INSERT INTO remapping_log (step, message) VALUES ('Step 18', 'Table faers_b.drug_mapper_2 does not exist, skipping Step 18');
        RETURN;
    END IF;

    SELECT COUNT(*) INTO row_count FROM faers_b.drug_mapper_2;
    IF row_count = 0 THEN
        INSERT INTO remapping_log (step, message) VALUES ('Step 18', 'Table faers_b.drug_mapper_2 is empty, skipping Step 18');
        RETURN;
    END IF;
    ...
    IF NOT EXISTS (
        ...
        INSERT INTO remapping_log (step, message) VALUES ('Step 18', 'Table faers_b.rxnconso does not exist, skipping Step 18');
        RETURN;
    END IF;
    ...
    INSERT INTO remapping_log (step, message) VALUES ('Step 18', 'Update RXAUI mappings completed successfully');
EXCEPTION
    WHEN OTHERS THEN
        INSERT INTO remapping_log (step, message) VALUES ('Step 18', 'Error in Step 18: ' || SQLERRM);
        RAISE;
END;
$$ LANGUAGE plpgsql;
...
BEGIN
    ...
    IF NOT table_exists THEN
        INSERT INTO remapping_log (step, message) VALUES ('Step 19', 'Table faers_b.drug_mapper_2 does not exist, skipping Step 19');
        RETURN;
    END IF;

    SELECT COUNT(*) INTO row_count FROM faers_b.drug_mapper_2;
    IF row_count = 0 THEN
        INSERT INTO remapping_log (step, message) VALUES ('Step 19', 'Table faers_b.drug_mapper_2 is empty, skipping Step 19');
        RETURN;
    END IF;
    ...
    IF NOT EXISTS (
        ...
        INSERT INTO remapping_log (step, message) VALUES ('Step 19', 'Table faers_b.rxnconso does not exist, skipping Step 19');
        RETURN;
    END IF;
    ...
    INSERT INTO remapping_log (step, message) VALUES ('Step 19', 'Non-RXNORM SAB update completed successfully');
EXCEPTION
    WHEN OTHERS THEN
        INSERT INTO remapping_log (step, message) VALUES ('Step 19', 'Error in Step 19: ' || SQLERRM);
        RAISE;
END;
$$ LANGUAGE plpgsql;
...
BEGIN
    ...
    IF NOT table_exists THEN
        INSERT INTO remapping_log (step, message) VALUES ('Step 20', 'Table faers_b.drug_mapper_2 does not exist, skipping Step 20');
        RETURN;
    END IF;

    SELECT COUNT(*) INTO row_count FROM faers_b.drug_mapper_2;
    IF row_count = 0 THEN
        INSERT INTO remapping_log (step, message) VALUES ('Step 20', 'Table faers_b.drug_mapper_2 is empty, skipping Step 20');
        RETURN;
    END IF;
    ...
    IF NOT EXISTS (
        ...
        INSERT INTO remapping_log (step, message) VALUES ('Step 20', 'Table faers_b.rxnconso does not exist, skipping Step 20');
        RETURN;
    END IF;
    ...
    INSERT INTO remapping_log (step, message) VALUES ('Step 20', 'RXNORM SAB specific update completed successfully');
EXCEPTION
    WHEN OTHERS THEN
        INSERT INTO remapping_log (step, message) VALUES ('Step 20', 'Error in Step 20: ' || SQLERRM);
        RAISE;
END;
$$ LANGUAGE plpgsql;

-- Populate manual_remapper
...
BEGIN
    ...
    IF NOT table_exists THEN
        INSERT INTO remapping_log (step, message) VALUES ('Populate Manual Remapper', 'Table faers_b.drug_mapper_2 does not exist, skipping');
        RETURN;
    END IF;

    SELECT COUNT(*) INTO row_count FROM faers_b.drug_mapper_2;
    IF row_count = 0 THEN
        INSERT INTO remapping_log (step, message) VALUES ('Populate Manual Remapper', 'Table faers_b.drug_mapper_2 is empty, skipping');
        RETURN;
    END IF;
    ...
    INSERT INTO remapping_log (step, message) VALUES ('Populate Manual Remapper', 'manual_remapper populated successfully');
EXCEPTION
    WHEN OTHERS THEN
        INSERT INTO remapping_log (step, message) VALUES ('Populate Manual Remapper', 'Error in Populate Manual Remapper: ' || SQLERRM);
        RAISE;
END;
$$ LANGUAGE plpgsql;

-- Merge manual remappings into drug_mapper_3
...
BEGIN
    ...
    IF NOT table_exists THEN
        INSERT INTO remapping_log (step, message) VALUES ('Merge Manual Remappings', 'Table faers_b.drug_mapper_2 does not exist, skipping');
        RETURN;
    END IF;

    SELECT COUNT(*) INTO row_count FROM faers_b.drug_mapper_2;
    IF row_count = 0 THEN
        INSERT INTO remapping_log (step, message) VALUES ('Merge Manual Remappings', 'Table faers_b.drug_mapper_2 is empty, skipping');
        RETURN;
    END IF;
    ...
    SELECT EXISTS (
        SELECT FROM pg_class 
        WHERE relnamespace = (SELECT oid FROM pg_namespace WHERE nspname = 'faers_b') 
        AND relname = 'manual_remapper'
    ) INTO table_exists;

    IF NOT table_exists THEN
        INSERT INTO remapping_log (step, message) VALUES ('Merge Manual Remappings', 'Table faers_b.manual_remapper does not exist, skipping');
        RETURN;
    END IF;
    ...
    IF NOT EXISTS (
        ...
        INSERT INTO remapping_log (step, message) VALUES ('Merge Manual Remappings', 'Table faers_b.rxnconso does not exist, skipping');
        RETURN;
    END IF;

    DROP TABLE IF EXISTS faers_b.drug_mapper_3;
    CREATE TABLE faers_b.drug_mapper_3 (
        drug_id TEXT,
        primaryid TEXT,
        drug_seq TEXT,
        role_cod TEXT,
    ...
    SELECT d.drug_id, d.primaryid, d.drug_seq, d.role_cod, d.period, d.drugname, d.prod_ai, d.notes,
           ...
           r.tty AS remapping_tty,
           r.code AS remapping_code
    FROM faers_b.manual_remapper m
    INNER JOIN faers_b.rxnconso r ON m.final_rxaui = r.rxaui
    RIGHT OUTER JOIN faers_b.drug_mapper_2 d ON m.source_rxcui = d.remapping_rxcui;

    DELETE FROM faers_b.drug_mapper_3
    WHERE (drug_id, drug_seq, final_rxaui) IN (
        ...
        FROM (
            ...
            FROM faers_b.drug_mapper_3
        ) t
        WHERE row_num > 1
    );

    INSERT INTO remapping_log (step, message) VALUES ('Merge Manual Remappings', 'drug_mapper_3 created and duplicates removed successfully');
EXCEPTION
    WHEN OTHERS THEN
        INSERT INTO remapping_log (step, message) VALUES ('Merge Manual Remappings', 'Error in Merge Manual Remappings: ' || SQLERRM);
        RAISE;
END;
$$ LANGUAGE plpgsql;

-- Driver function to orchestrate remapping
CREATE OR REPLACE FUNCTION faers_b.run_all_remapping_steps() RETURNS VOID AS $$
BEGIN
    PERFORM faers_b.step_1_initial_rxnorm_update();
    PERFORM faers_b.step_2_create_drug_mapper_2();
    PERFORM faers_b.step_3_manual_remapping_update();
    PERFORM faers_b.step_4_manual_remapping_insert();
    PERFORM faers_b.step_5_manual_remapping_delete();
    PERFORM faers_b.step_6_vandf_relationships();
    PERFORM faers_b.step_7_mmsl_to_rxnorm_insert();
    PERFORM faers_b.step_8_rxnorm_scdc_to_in_insert();
    PERFORM faers_b.step_9_rxnorm_in_update_with_notes();
    PERFORM faers_b.step_10_mthspl_to_rxnorm_in_insert();
    PERFORM faers_b.step_11_rxnorm_in_update();
    PERFORM faers_b.step_12_mmsl_to_rxnorm_in_insert_exclusions();
    PERFORM faers_b.step_13_rxnorm_cleanup_update();
    PERFORM faers_b.step_14_mark_for_deletion();
    PERFORM faers_b.step_15_reinsert_from_deleted();
    PERFORM faers_b.step_16_delete_marked_rows();
    PERFORM faers_b.step_17_clean_duplicates();
    PERFORM faers_b.step_18_update_rxaui_mappings();
    PERFORM faers_b.step_19_non_rxnorm_s