...
try:
    ...
    print(f"Error importing s8 module: {e}")
    print(f"Project root path: {project_root}")
    raise


class TestS8Pipeline(unittest.TestCase):
    """Comprehensive test suite for s8.py script - DRUG_Mapper_Temp processing."""
    ...
    @patch('builtins.open', new_callable=mock_open)
    def test_load_s8_config_file_not_found_detailed(self, mock_file):
        """Test S8 configuration loading when file is not found (detailed)."""
        mock_file.side_effect = FileNotFoundError()
    ...
    @patch('builtins.open', new_callable=mock_open)
    @patch('json.load')
    def test_load_s8_config_invalid_json_detailed(self, mock_json_load, mock_file):
        """Test S8 configuration loading with invalid JSON (detailed)."""
        mock_json_load.side_effect = json.JSONDecodeError("Invalid JSON", "doc", 0)
    ...
    def test_create_config_temp_table_success(self):
        ...
        s8.create_config_temp_table(mock_cursor, self.advanced_s8_config)
    ...
    def test_config_temp_table_json_serialization(self):
        ...
        for phase_name, phase_config in self.advanced_s8_config.items():
    ...
    def test_parse_sql_statements_with_functions_and_config_blocks(self):
        ...
        # Should have 4 statements: CREATE TEMP TABLE, CREATE FUNCTION, DO block, INSERT
    ...
    # ============================================================================
    # S8-SPECIFIC FUNCTIONALITY TESTS
    # ============================================================================
...
class TestS8Integration(unittest.TestCase):
    """Integration tests for s8.py - DRUG_Mapper_Temp processing."""
...
if __name__ == '__main__':
    ...
    print("This tests the s8.py Python script for DRUG_Mapper_Temp processing")
    print("Step 8 of the FAERS data processing pipeline")
    print("Features: S8-specific config, temp config table creation, drug mapping")
    print()
    ...
    # Add test classes
    suite.addTests(loader.loadTestsFromTestCase(TestS8Pipeline))
    suite.addTests(loader.loadTestsFromTestCase(TestS8Integration))
